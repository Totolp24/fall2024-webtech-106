...
export default function Header() {
  ...
  <img src="/logo/logo.webp" className="w-5 object-cover transform hover:scale-110 transition-transform duration-300"/>
</a>
        </div>
        ...
        <div className="ml-4">
          <button
            className=" px-6 py-3 rounded-md hover:bg-blue-700"
